...
public class SysRoleController extends BaseController {
    ...
    @PostMapping("/list")
    @ResponseBody
    public PageResult list(SystemRole role) {
        startPage();
    ...
    @ResponseBody
    public AjaxResult changeStatus(SystemRole role) {
        roleService.checkRoleAllowed(role);
    ...
    @ResponseBody
    public PageResult allocatedList(SystemUser user) {
        startPage();
    ...
    @ResponseBody
    public PageResult unallocatedList(SystemUser user) {
        startPage();

...
import com.kanon.common.core.entity.CxSelect;
import com.kanon.common.json.JSONObject;
import com.kanon.common.json.JSONObject.JSONArray;
...
public class DemoFormController {
    ...
    public AjaxResult collection() {
        String[] array = {"kanon 1", "kanon 2", "kanon 3", "kanon 4", "kanon 5"};
        AjaxResult ajax = new AjaxResult();

...
import com.kanon.common.core.entity.AjaxResult.Type;
...
import com.kanon.common.utils.sql.SqlUtil;
...
public class BaseController {
    ...
    protected void startPage() {
        PageData pageData = TableSupport.buildPageRequest();
    ...
    protected void startOrderBy() {
        PageData pageData = TableSupport.buildPageRequest();
        if (StringUtils.isNotEmpty(pageData.getOrderBy())) {
            String orderBy = SqlUtil.escapeOrderBySql(pageData.getOrderBy());

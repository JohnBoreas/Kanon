...
import com.kanon.common.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.kanon.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            if (currentUser != null) {
                operLog.setOperName(currentUser.getUserId());
            }
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(Log log, SystemOperateLog operLog) throws Exception {
        // 设置action动作
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(SystemOperateLog operLog) throws Exception {

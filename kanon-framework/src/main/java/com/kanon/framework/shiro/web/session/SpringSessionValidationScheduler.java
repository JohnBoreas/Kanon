package com.kanon.framework.shiro.web.session;
...
public class SpringSessionValidationScheduler implements SessionValidationScheduler {
    ...
    @Autowired
    public SpringSessionValidationScheduler(@Qualifier("scheduledExecutorService") ScheduledExecutorService executorService,
                                            @Qualifier("sessionManager") @Lazy ValidatingSessionManager sessionManager) {
